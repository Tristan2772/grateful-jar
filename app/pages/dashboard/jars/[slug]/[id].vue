  ...
  <div>
    ...
    <div v-if="route.name === 'dashboard-jars-slug-id' && note && !loading">
      <div class="flex pb-40">
        <div class="flex flex-col gap-2 items-center text-center fixed bottom-0 pt-20 z-10 transition-all duration-300 pointer-events-none max-h-[80vh]" :class="{ 'left-16': !sidebarStore.isSidebarOpen, 'left-16 md:left-64': sidebarStore.isSidebarOpen, 'right-3': !isExpanded }">
